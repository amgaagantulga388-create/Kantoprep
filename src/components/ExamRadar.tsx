...
function getPhaseInfo(daysLeft: number) {
  if (daysLeft <= 14) {
    return {
  ...
  if (daysLeft <= 45) {
    return {
      ...
      badge: 'bg-[#F5B942]/15 text-[#F5B942] border-[#F5B942]/35',
      icon: Zap,
        ...
        <div className="flex items-center space-x-2 self-start sm:self-auto">
          {selectedCurriculum !== 'ALL' && (
            ...
            >
              ...
              <span>Reset filter ({selectedCurriculum})</span>
            </button>
          )}
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
              {milestones.map((m) => {
                ...
                const phase = getPhaseInfo(daysLeft);
                  ...
                  >
                    ...
                    <div>
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <div className="flex items-center space-x-2">
                          <span
                            className={`px-2.5 py-1 rounded-lg text-xs font-bold uppercase tracking-wider border ${m.primaryColor.bg} ${m.primaryColor.text} ${m.primaryColor.border}`}
                          >
                            {m.badgeLabel}
                          </span>
                          {isSelected && (
                      ...
                      {/* Big D-Day Ticker */}
                      <div className="my-3.5 p-3 rounded-xl bg-[#0E0D0B]/60 border border-[#F5B942]/15 flex items-baseline justify-between">
                        <div>
